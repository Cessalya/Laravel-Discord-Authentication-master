    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        <form action="/crudinsert" method="POST" enctype="multipart/form-data">
                        @csrf    
                        <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nama Barang</label>
                                <input type="text" name="namabarang" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Enter Nama Barang">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="action" aria-label="Default select example">
                                    <option selected>Pilih Keterangan Barang</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name ="kodebarang"class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Enter Kode Barang">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name ="jumlahbarang"class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Enter Jumlah Barang">
